...
type CartHandler interface {
	...
	CreateOrder(c *bot.TgRequest)
}

// need manager / customer variant
...
type BaseHandler struct {
	...
	oFactory factories.OrderMurkupFactory
}
...
func NewBaseHandler(bot *tgbotapi.BotAPI, api api.Api, service *service.Service) *BaseHandler {
	...
	return &BaseHandler{bot: bot, api: api, service: service, mFactory: factory, cFactory: factory, oFactory: factory}
}
